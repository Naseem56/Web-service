...
function showHint(str) {
  ...
  xhttp.open("GET", "http://localhost:8080/MailService/webapi/profile/checkId?mailId="+str, true);
  xhttp.send();   
}
      ...
      <div id="header-main-right-nav">
          ...
          <table border="0" style="border:none">
            ...
            <tr>
              ...
              <td><label><a href="" style="color:#ccc; text-decoration:none"></a></label></td>
            </tr>
          </table>
        </form>
      </div>
...
<div class="loginbox radius">
  ...
  <div class="loginboxinner radius">
    ...
    <!--loginheader-->
    <div class="loginform">
      <form  id="login" name="myform" action="http://localhost:8080/MessageService/webapi/profile/signup" method="post">
        <p>
        ...
        <input class="radius title"  type="submit" class="fbbutton" name="login" value="Signup" /> 
        </p>
